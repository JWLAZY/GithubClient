...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func customUI() {
        ...
        UINavigationBar.appearance().titleTextAttributes = NSDictionary.init(object: UIColor.white, forKey: NSForegroundColorAttributeName as NSCopying) as? [String : AnyObject]
    }
    func customSocial()  {
